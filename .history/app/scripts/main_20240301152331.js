...
const carouselItems11 = document.querySelectorAll('.dangki-carousel-border');
const carouselItems12 = document.querySelectorAll('.review-carousel-img');

// Số lượng phần tử trong carousel
const totalItems = carouselItems1.length;
