...
//
// Lấy tất cả các phần tử carousel border
const carouselItems1 = document.querySelectorAll('.review-carousel-img');
...
// Hiển thị phần tử đầu tiên khi trang được tải
showItem1(currentItemIndex1);

// Hàm tự động chuyển đổi carousel
function autoChangeCarousel1() {
    currentItemIndex1++;
...
// Thiết lập tự động chuyển đổi sau mỗi khoảng thời gian
const intervalId1 = setInterval(autoChangeCarousel1, 3000); // Thay đổi 3000 để điều chỉnh thời gian chuyển đổi

// Xử lý khi bấm vào mũi tên trái
document.querySelector('.left-arrow').addEventListener('click', () => {
    clearInterval(intervalId1); // Dừng tự động chuyển đổi
    currentItemIndex1--;
...
//modal
// Get the modal
var modal = document.getElementsBy("myModal");
